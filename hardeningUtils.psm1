# From Dissembler0 originally
#Help file external to this now, and can be accessed via 
# `help about_hardeningUtils`
# after module import
...
function get-appxinstallation {
	try {
		$canInstall = Install-Module appx -WhatIf
		if ($canInstall) {
			Install-Module appx
		}
		else {
		...
		write-host "Unable to install appx"
	}
}
